        ...
        Container(
          child: Padding(
            ...
            child: Text("Interesting fact: Watermelon is actually considered a "
                ...
                "Watermelon Promotion Board. Getting plenty of water — both by"
                "drinking it and by consuming foods that contain lots of water — will "
                "help you stay hydrated. Getting enough fluids is important for all aspects of health,"
                " including migraine."),
          ),
        ),
            ...
            Container(
              child: Padding(
                ...
                "Bananas are about 74 percent water, so there are hydration "
                    "benefits as well which helps with Migraine"),
              ),
            ),
            ...
            Container(
              ...
              'the American Headache Society concluded that riboflavin is “probably effective'
              'for preventing migraine or headaches.'
              ),
            ),),
            ...
            Container(
              child: Padding(
                ...
                child: Text("Changes in hormone levels can lead to headaches, especially "
                    ...
                    'estrogen.'
                    'Cruciferous vegetables contain hormonally active compounds called '
                    'phytoestrogens, which can have estrogenic, or estrogen-like, effects'
                    'in humans — or, conversely, antiestrogenic effects.Some research, '
                    'cited in a February 2021 review in Climacteric,'
                   ' indicates phytoestrogens improve bone mineral density and markers of'
                    'cardiovascular risk in post-menopausal women — effects that estrogen'
                    'would be expected to have in premenopausal women.'
            ),
            ),
            ),],
        ),
