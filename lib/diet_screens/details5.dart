            ...
            Container(
              child: Padding(
                ...
                child: Text("Peppers are amongst the richest sources of vitamin C, a water-"
                    ...
                    "those with lower vitamin C intake (8Trusted Source).Consuming just one "
                    "medium-sized (119-gram) sweet red pepper delivers 169% of the"
            ...
            Container(
              child: Padding(
                  ...
                  child: Text("Cocoa and cacao products like dark chocolate are high in "
                      ...
                      "Try adding cocoa to your fruits intake to help support the health"
                      "ofyour lungs")
              ),
            ),
          ],
