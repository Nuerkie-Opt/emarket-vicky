            ...
            Container(
              child: Padding(
                ...
                child: Text("Apples are rich in fiber. In fact, one medium apple with the "
                    ...
                    "One study in 80 people with constipation found that pectin accelerated "
                    "stool movement through the intestines, improved symptoms of constipation"
                    " and increased the amount of beneficial bacteria in the gut."
                    "Apples are an easy way to boost the fiber content of your diet and alleviate "
                    "constipation. "
                    "You can eat them whole on their own or slice them up to add to salads"),
              ),
            ),
            ...
            Container(
              child: Padding(
                ...
                child: Text("Pears are another fruit rich in fiber, with about 5.5 grams of "
                    ...
                    " osmosis, stimulating a bowel movement (16Trusted Source).Pears also"
                    " contain the sugar alcohol sorbitol. Like fructose, sorbitol is "
                    "not well absorbed by the body and acts as a natural laxative by "
                    "bringing water into the intestines (15Trusted Source).You can include"
                    " pears in your diet in a wide variety of ways. Eat them raw or include "
                    "them in your savory dishes.")
        ,
              ),
            ),
              ...
              child: Padding(
                ...
                child: Text("One kiwi (about 75 grams) contains about 2.3 grams of fiber, "
                   ...
                   'Furthermore, a 2010 study gave 54 people with irritable bowel syndrome '
                    ...
                    'transit times.It’s not just the fiber in kiwis that’s thought to fight'
                    'constipation. An enzyme known as actinidin is also hypothesized to be'
                    'responsible for kiwi’s positive effects on gut motility and bowel habits'
      'Kiwis can be eaten raw. Just peel them or cut them in half and scoop out the green '
              'flesh and seeds. They make a great addition to fruit salads and can be added to '
            ...
            Container(
              child: Padding(
                ...
                child: Text("Citrus fruits like oranges, grapefruits, and mandarins are a "
                    ...
                    'effect. However, more research in humans is needed.'
                    'To get the maximum amount of fiber and vitamin C, eat citrus fruits fresh.'
                    'Oranges and mandarins are a handy snack food, and grapefruit goes'
                    'well in a salad or cut in half for breakfast.'
                ),
              ),
            ),],
        ),
